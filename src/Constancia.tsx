...
const styles = StyleSheet.create({
    ...
    rotateImage: {
        ...
        transform: "scale(1.2)",
        //aspectRatio:"9:16"
        objectFit: "contain" /* Ensures the image is fully contained within its box without stretching */,
    },
    firmasContainer: {
        width: "50%",
        display: "flex",
...
const MyDocument = () => {
    ...
    const fetchRecImagen = async (imagenRec: string) => {
        try {
            const { data, error } = await supabase.storage.from("imagenes_servicios").createSignedUrl(imagenRec, 3600); // 3600 seconds = 1 hour
        ...
        <PDFViewer width="100%" height="100%">
            <Document>
                <Page wrap={false} size={"LETTER"} style={{ ...styles.body }}>
                    ...
                    <View style={styles.header}>
                        ...
                        <View style={styles.folioSection}>
                            ...
                            <View style={styles.folioBox}>
                                <Text>{(folio as any) < 0 ? `FT-${(folio as any) * -1}` : folio}</Text>
                            </View>
                        </View>
                    </View>
                    <View>
                        <View style={styles.midTitle}>
                            <Text style={{ ...styles.title, width: "100%", fontSize: "20px", textAlign: "center" }}>
                    ...
                    <View style={{ ...styles.fechaSection, marginBottom: "-100px" }}>
                        ...
                        <View style={{ display: "flex", flexDirection: "row", gap: "10px" }}>
                            ...
                            <View style={styles.fechaElement}>
                                ...
                                <Text style={styles.fechaUnderline}>
                                    {" "}
                                    {servicio[0]?.horario_entrada || servicio[0]?.horario_servicio}
                                </Text>
                            </View>
                            <View style={styles.fechaElement}>
                                <View style={{ width: "30%" }}>
                    ...
                    <View style={{ ...styles.fechaSection }}>
                        ...
                        <View style={{ display: "flex", gap: "10px", width: "100%" }}>
                            <View style={{ ...styles.fechaElement, width: "100%" }}>
                                ...
                                <Text style={{ ...styles.fechaUnderline, width: "84%" }}>
                                    {" "}
                            ...
                            <View style={{ ...styles.fechaElement, width: "100%" }}>
                                ...
                                <Text style={{ ...styles.fechaUnderline, width: "84%" }}>
                                    {direccion[0]?.calle} {direccion[0]?.numero_ext}{" "}
                                    {direccion[0]?.numero_int ? direccion[0]?.numero_int : null} {direccion[0]?.colonia}{" "}
                                    {direccion[0]?.ciudad} {direccion[0]?.estado}{" "}
                                    {direccion[0]?.codigo_postal ? direccion[0]?.codigo_postal : null}
                                </Text>
                            </View>
                            <View style={{ ...styles.fechaElement, width: "100%" }}>
                                <View style={{ width: "16%" }}>
                            ...
                            <View style={{ ...styles.fechaElement, width: "100%" }}>
                                <View style={{ ...styles.fechaElement, width: "50%" }}>
                                    ...
                                    <Text style={{ ...styles.fechaUnderline, width: " 68%" }}>
                                        {" "}
                                        {servicio[0]?.Responsables?.nombre}
                                    </Text>
                                </View>
                                <View style={{ ...styles.fechaElement, width: "50%" }}>
                                    <View style={{ width: "16%" }}>
                                    ...
                                    <Text style={{ ...styles.fechaUnderline, width: "84%" }}>
                                        {" "}
                                        {servicio[0]?.Responsables?.puesto}{" "}
                                    </Text>
                                </View>
                            </View>
                            <View style={{ ...styles.fechaElement, width: "100%" }}>
                                ...
                                <View style={{ ...styles.fechaElement, width: "50%" }}>
                                    ...
                                    <Text style={{ ...styles.fechaUnderline, width: "84%" }}>
                                        {" "}
                                        {servicio[0]?.Responsables?.telefono}{" "}
                                    </Text>
                                </View>
                            </View>
                        </View>
                                        ...
                                        >
                                            <Text style={{ width: "100%", padding: 0, margin: 0, flexGrow: 1 }}>
                                                {registro?.dosis_recomendada === "max"
                                                    ...
                                                    : registro?.dosis_recomendada === "min"
                    ...
                    <View style={{ ...styles.fechaSection, marginTop: "-20px" }}>
                        <View
                            style={{
                                ...
                                alignItems: "center",
                                justifyContent: "center",
                                backgroundColor: "rgb(14,78,127)",
                            }}
                        >
                            <Text style={{ paddingLeft: "3px" }}>INFORMACIÓN DEL CLIENTE</Text>
                        </View>
                        <View
                            style={{ ...styles.registrosINfo, justifyContent: "flex-start", paddingHorizontal: "12px" }}
                        >
                    ...
                    <View style={{ ...styles.section, marginBottom: "50px" }}>
                        <View style={styles.checkboxContainer}>
                            <View
                                style={[
                                    styles.checkbox,
                                    { backgroundColor: frecuencia_recomendada === "Semanal" ? "black" : "white" },
                                ]}
                            />
                        ...
                        <View style={styles.checkboxContainer}>
                            <View
                                style={[
                                    styles.checkbox,
                                    { backgroundColor: frecuencia_recomendada === "Quincenal" ? "black" : "white" },
                                ]}
                            />
                        ...
                        <View style={styles.checkboxContainer}>
                            <View
                                style={[
                                    styles.checkbox,
                                    { backgroundColor: frecuencia_recomendada === "Mensual" ? "black" : "white" },
                                ]}
                            />
                        ...
                        <View style={styles.checkboxContainer}>
                            <View
                                style={[
                                    styles.checkbox,
                                    { backgroundColor: frecuencia_recomendada === "Ninguna" ? "black" : "white" },
                                ]}
                            />
                    ...
                    >
                        <Text style={{ paddingLeft: "3px", height: "100%" }}>
                            GARANTIA DE ACUERDO AL TIEMPO SUGERIDO PARA REALIZAR EL PROXIMO SERVICIO Y CUMPLIR CON LAS
                ...
                <Page size={"LETTER"} style={styles.body}>
                    ...
                    <View style={{ ...styles.fechaSection, marginTop: "30px" }}>
                        ...
                        >
                            <Text style={{ paddingLeft: "30px", fontSize: "14px", fontWeight: "bold" }}>
                                REPORTE FOTOGRÁFICO
                            </Text>
                            <Text style={{ paddingLeft: "3px" }}>
                                INSPECCIÓN Y RECOMENDACIONES DE ACUERDO A MANEJO INTEGRADO DE PLAGAS
                            </Text>
                        </View>
                        ...
                        {recomendaciones?.map((rec, index) => (
                            ...
                            >
                                {/* Left Column */}
                                <View
                                    style={{ display: "flex", flexDirection: "column", maxWidth: "30%", flexGrow: 1 }}
                                >
                                    <View>
                                    ...
                                    >
                                        {imagenUrl?.[index] !== "" && (
                                            <>
                                                <Image
                                                    src={imagenUrl?.[index]}
                                                    style={{ ...styles.rotateImage, width: "75px" }}
                                                />
                                            </>
                                        )}
                    ...
                    <View>
                        <View style={{ ...styles.reporteFotográficoContainer, height: "50%" }}>
                            <View style={{ display: "flex", height: "10%", flexDirection: "row" }}>
                                ...
                                >
                                    <Text style={{ paddingLeft: "3px" }}>
                                        CLIENTE RECIBE SERVICIO Y RECOMENDACIONES
                                    </Text>
                                </View>
                                <View
                                    style={{
                            ...
                            <View style={{ ...styles.reporteFotográficoInfo, height: "90%", flexDirection: "row" }}>
                                <View style={styles.firmasContainer}>
                                    ...
                                    <Text style={{ color: "black", marginBottom: "10px" }}>
                                        {/* @ts-ignore */}
                                        {servicio[0]?.Empleados?.nombre}
                                    </Text>
                                    <View style={{ ...styles.firmasContainer, marginBottom: "5px" }}>
                                        <Text>NOMBRE Y FIRMA TÉCNICO</Text>
                                    </View>
                                </View>
                                <View style={styles.firmasContainer}>
                                    {firma ? (
                                    ...
                                    <View style={{ ...styles.firmasContainer, width: "60%", marginBottom: "5px" }}>
                        ...
                        <View style={{ display: "flex", height: "15%", flexDirection: "column", marginTop: "8px" }}>
                            ...
                            >
                                <Text style={{ paddingLeft: "3px", fontSize: "16px" }}>
                                    Faro de San Sebastian 115 - A Frac. El Faro. León Gto.
                                </Text>
                                <Text style={{ paddingLeft: "3px", fontSize: "12px", marginVertical: "5px" }}>
                                    Tel: 777-85-64 477-228-75-65
                                </Text>
                                <View
                                    style={{
                                        display: "flex",
                        ...
                        >
                            ...
                            >
                                <Text style={{ paddingLeft: "3px", fontSize: "16px", marginTop: "4px" }}>
                                    LICENCIA SANITARIA 08-11A182
                                </Text>
                                <View
                                    style={{
                                        display: "flex",
