...
export type Database = {
    ...
    public: {
        Tables: {
            ...
            Equipos: {
                Row: {
                    ...
                    estacion_de_control: Database["public"]["Enums"]["estaciondecontrol"] | null;
                    id: number;
                    image: string | null;
                    marca: string | null;
                    modelo: string | null;
            ...
            Inventario: {
                Row: {
                    ...
                    tipo_de_equipo: Database["public"]["Enums"]["TipoEquipoOptions"] | null;
            ...
            Productos: {
                Row: {
                    ...
                    presentacion_unidad: Database["public"]["Enums"]["PresentacionUnidad"] | null;
            ...
            RegistroAplicacion: {
                Row: {
                    ...
                    created_at: string;
                    dosis_recomendada: Database["public"]["Enums"]["DosisRecomendada"] | null;
            ...
            Servicios: {
                Row: {
                    ...
                    folio: number;
                    frecuencia_recomendada: Database["public"]["Enums"]["FrecuenciaServicio"] | null;
        ...
        Functions: {
            ...
            generate_temporal_folio: { Args: never; Returns: number } | { Args: { org_name: string }; Returns: number };
        };
        Enums: {
            ...
            TipoEquipo: "computo" | "bomba_ulv" | "termo_nebulizadora" | "estacion_control" | "otro";
            TipoEquipoOptions: "Plaguicidas" | "Equipos de control" | "Computo" | "Otros";
            TipoFeedback:
                | "ErrorInterfaz"
                | "ErrorCargando"
                | "ErrorGuardando"
            ...
            TipoMovimiento: "salida" | "traspaso" | "caducidad" | "venta" | "basura" | "servicio" | "entrada" | "error";
