(function (w, d) {
            ...
            getBaseDomain: function () {
                ...
                if (domain) {
                    try {
                        ...
                        io.util
                            .logger("Shared Utils")
                            .error("getBaseDomain() error", "domain:" + domain + " msg:" + e.message);
                    }
                }
                return domain;
            },
        ...
        var checkForNativeJsonParse = function () {
            ...
            var isNativeFunction = function (func) {
                ...
                return type === "function"
                    ...
                    : (func && type === "object" && _reHostCtor.test(_toString.call(func))) || false;
            };
    ...
    function getSlugObject(beacon, xhr, image, iframe) {
        return { beacon: beacon, xhr: xhr, img: image, iframe: iframe };
    }
    ...
    function doBeacon(url, slugs) {
        ...
        var parts = url.split("?");
        var beaconResponse =
            url.length < 8191 && w.navigator.sendBeacon ? w.navigator.sendBeacon(parts[0], parts[1]) : false;
        ...
        while (x < xx) {
            ...
            while (y < yy) {
                if (tids[y] == trackId) {
                    ...
                    if (
                        (cfg.vs || options.verifySiteDefinitionMatch) &&
                        !regexMatch(cfg.d, stripProtocol(landingPage), true)
                    ) {
    ...
    function setUUIDAndNextXhrExpiry(uuid) {
        ...
        uuidAndNextXhrExpiry =
            (!u.isEmpty(uuid) ? uuid : timeStamp.toString() + "." + Math.random().toString(36).substring(2, 15)) +
            "|" +
            (timeStamp + 24 * 60 * 60 * 1000);
        u.setCookie(uuidCkName, uuidAndNextXhrExpiry, 720);
    }
    function getOptionsOverrides(options, campCfg) {
        return u.extend({ node: campCfg.tag || "img", domReady: campCfg.domReady }, options);
    }
                    ...
                    while (i < len) {
                        ...
                        if (it.custparam) {
                            tagSrc +=
                                ...
                                "=" +
                                encodeURIComponent(
                                    encodeURIComponent(it.custparam["name"]) +
                                        "=" +
                                        encodeURIComponent(it.custparam["value"])
                                );
                        }
                        i += 1;
                    }
                    ...
                    if (props[n]) {
                        ...
                        if (nm === "irchannel") {
                            ...
                            tagSrc +=
                                ...
                                "=" +
                                encodeURIComponent(
                                    nm === "custemail" && emailRegex.test(props[n]) ? sha1(props[n]) : props[n]
                                );
                        }
                    }
                }
                    ...
                    try {
                        for (var x = 0, xx = postbacks.length; x < xx; ++x) {
                            ...
                            if (pb.u) {
                                ...
                                if (pb.c) {
                                    var node = doDomNode(false, { tag: "iframe", id: "impactPiggyFrame" + x }),
            ...
            if (domMode) {
                ...
                if (options.tag) {
                    switch (options.tag) {
                        case "xhr":
                            obj =
                                doXHR(urlWithParams, slugs, pb, function (val) {
                                    var innerUrl = urlWithParams + buildQueryParam(xhrf, val);
                                    obj = doBeacon(innerUrl, slugs) || doDomNode(innerUrl, options, slugs);
                                    doCallbacksAndReporter(
                                        obj,
                                        replaceSubmissionSlug(urlWithParams, getTrackingMethod(obj), slugs)
                                    );
                                }) ||
                                doBeacon(urlWithParams, slugs) ||
                        ...
                        xhrObj =
                            doXHR(
                                ...
                                function (responseText) {
                                    ...
                                    doCallbacksAndReporter(
                                        xhrObj,
                                        replaceSubmissionSlug(urlAndParams, "xhr", slugs),
                                        "xhr"
                                    );
                                },
                                function (failValue) {
                            ...
                            (function () {
                                ...
                                doCallbacksAndReporter(
                                    xhrObj,
                                    replaceSubmissionSlug(urlAndParams, options.tag, slugs),
                                    options.tag
                                );
                            })();
                }
    ...
    Event.prototype = {
        ...
        secureConversion: function (trackerId, encryptStr, iv, props, options) {
            ...
            try {
                ...
                doTracking(
                    ...
                    options,
                    "secureConversion",
                    getSlugObject("bconv", "xconv", "jconv", "jifconv"),
                    false,
                    true
                );
            } catch (e) {
        ...
        identify: function (props, options) {
            ...
            var finishedCallback = function () {
                ...
                if (camp.csc["fq"] && (nsess || willFireIdentify)) {
                    this.trackQuality(
                        ...
                        u.extend(options, { noPassProps: true }),
                        camp
                    );
                }
                if (camp.ld) {
                ...
                function hasMatchingAndRules(andRules) {
                    function ruleMet(rule) {
                        function matchesRule(rule, value) {
                            ...
                            switch (ruleOperator) {
                                ...
                                case "ew":
                                    return (
                                        value &&
                                        value.length >= ruleValue.length &&
                                        safeLowerCase(value).substr(value.length - ruleValue.length) ==
                                            safeLowerCase(ruleValue)
                                    );
                                case "r":
                        ...
                        function matchesQueryParamRule(url) {
                            ...
                            var pv = extractQueryParam(
                                url,
                                ruleAttribute,
                                ruleValue && !u.strContains(ruleValue, "%2") && !u.strContains(ruleValue, "+")
                            );
            ...
            function getSlugs(isChannel) {
                ...
                return getSlugObject(
                    appendForChannel("bc"),
                    appendForChannel("xc"),
                    appendForChannel("pc"),
                    appendForChannel("ifc")
                );
            }
            ...
            function buildTagSrc(undefSrcValue, matchId, isChannel, lp, c, rd, ref) {
                ...
                function isSeo(r) {
                    return /\b(google|yahoo|msn|bing|aol|lycos|ask|altavista|netscape|cnn|looksmart|about|mamma|alltheweb|gigablast|voila|virgilio|live|baidu|alice|yandex|najdi|club-internet|mama|seznam|search|szukaj|netsprint|google.interia|szukacz|yam|pchome)\b/.test(
                        r
                    );
                }
                var tagParams = "",
                ...
                tagParams += "&" + getMappedQueryString(props, { customeremail: "custemail", customerid: "custid" });
            ...
            try {
                ...
                if (
                    !hasInvokedIdentify &&
                    shouldEval(nsess, referrer, camp, referrerDomain, landingPage, gatewayClickId, googleClickId)
                ) {
                    ...
                    if (
                        matchingId &&
                        getMsId(matchingId, isChannel, landingPage, googleClickId, camp) !== getCookieMsId(camp.iw) &&
                        matchingId !== blackListMatchingId
                    ) {
                        nodeSrc = buildTagSrc(
                            undefSrcValue,
                            matchingId,
                ...
                doSessionSpecificTasks(
                    this,
                    camp,
                    getMsId(matchingId, isChannel, landingPage, googleClickId, camp),
                    gatewayClickId,
                    passedSessionId,
                    googleClickId
                );
        ...
        trackConversion: function (trackId, props, options) {
            ...
            try {
                ...
                if (camp.ccc["fq"]) {
                    var passedParams = { requestType: "action" };
                    if (props.orderid) {
                        passedParams.stId = props.orderid;
                    }
                    this.trackQuality(u.extend(props, passedParams), u.extend(options, { noPassProps: true }), camp);
                }
            } catch (e) {
            ...
            try {
                if (props.actionTrackerId) {
                    ...
                    var src =
                        ...
                        slug +
                        "/" +
                        getCookieMsId(camp.iw) +
                        "/" +
                        camp.id +
                        "?evt=" +
                        encodeURIComponent(evt) +
                        "&" +
                        getMappedQueryString(props);
                    doSessionSpecificTasks(this, camp);
        ...
        generateClickId: function (callback, props, options) {
            ...
            var runGenerateClickId = function () {
                ...
                doXHR(
                    getTrackDomain(camp) + "/" + slug + "/" + camp.id,
                    slugs,
                    function (responseText) {
        ...
        identifyUser: function (props, options, passedCampaign, finishedCallback) {
            ...
            src += getMappedQueryString(props, { customeremail: "custemail", customerid: "custid" });
            ...
            w.MutationObserver =
                ...
                (function (w) {
                    ...
                    function A(a, b, c, d) {
                        ...
                        for (g in c) {
                            f[g] || a.push(p({ target: b, type: "attributes", attributeName: g, oldValue: c[g] }));
                        }
                    }
                    function K(a, b, c, d) {
                                    ...
                                    m === t
                                        ? (d.b && e.b && A(a, m, e.b, d.f),
                                          d.a &&
                                              e.a !== w &&
                                              m.nodeValue !== e.a &&
                                              a.push(p({ type: "characterData", target: m, oldValue: e.a })),
                                          l && f(l, b, g, q, z),
                    ...
                    for (var x = 0, xx = links.length; x < xx; x++) {
                        ...
                        if (!u.isEmpty(href)) {
                            ...
                            if (!u.strContains(hrefDomain, domain)) {
                                if (
                                    (props.domains && u.arrayContains(props.domains, hrefDomain, true)) ||
                                    regexMatch(camp.d, stripProtocol(href), true)
                                ) {
    ...
    var irEvent = new ImpactRadiusEvent("A2346528-7c55-4176-bb64-ba0700000dda1", "U31", [
        {
            id: "11703",
            td: "imp.i326929.net",
            ad: "834362",
            iw: null,
            ti: ["21486"],
            d: "(?:(?:.*?\\.picsart\\.com)|(?:^picsart\\.com)|(?:.*?\\.picsartstage2\\.com)|(?:^picsartstage2\\.com)|(?:.*?\\.picsartstage2\\.com))",
            pc: [
                {
                    1398851: {
                        r: [
                            [
                                {
                                    o: "m",
                                    t: "lu",
                                    v: "https://picsart.com/gold?utm_source=affiliate&utm_medium=impact&utm_campaign=Indoleads2019",
                                },
                            ],
                        ],
                        b: 0,
