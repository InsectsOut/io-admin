...
(function () {
            ...
            default:
                b
                    ? ((g = g || ua),
                      "image" == b
                          ? wc(e, ca, g)
                          : ("xhr" == b && wd(e, ca, g)) || ("beacon" == b && x(e, ca, g)) || ba(e, ca, g))
                    : ba(e, ca, g);
        }
        ca = h(l);
        g = ca.hitcount;
            ...
            if (!a.get(Qe) && (a.set(Qe, !0), !a.get("&gtm"))) {
                ...
                if (b) {
                    O["google.tagmanager.debugui2.queue"] ||
                        ((O["google.tagmanager.debugui2.queue"] = []),
                        Id(
                            "https://www.google-analytics.com/debug/bootstrap?id=" + a.get(Na) + "&src=LEGACY&cond=" + b
                        ));
    ...
    var Sd = function (a) {
        ...
        if (b) {
            ...
            c && a.set(Od, 1, !0);
            if (b || c)
                (a.set(ad, "d", !0), J(79), a.set(qe, { U: re(a, 1), google: re(a, 2), V: Me(a), count: 0 }, !0));
        }
    };
    var Lc = function () {
    ...
    function pd(a) {
        ...
        var g = (e = M.body) && e.clientWidth && e.clientHeight,
            ca = [];
        c && c.clientWidth && c.clientHeight && ("CSS1Compat" === M.compatMode || !g)
    ...
    var u = function (a, b, c) {
        ...
        B = function (a) {
            ...
            if (
                ...
                (jf && ((b = M.createElement("a")), (b.href = jf), (b = kf(b)), a.host === b[0] && a.port === b[1]))
            )
                return !0;
        ...
        ae = function (a) {
            ...
            D(a, "//")
                ...
                : D(a, "/")
                  ...
                  : !a || D(a, "?")
                    ? (a = g + d[2] + (a || e))
                    : 0 > a.split("/")[0].indexOf(":") && (a = g + d[2].substring(0, d[2].lastIndexOf("/")) + "/" + a);
            b.href = a;
            c = kf(b);
            return {
