            ...
            ((this.LOCATOR_NAME = "__gppLocator"),
                ...
                (this.addFrame = function (t) {
                    ...
                    return (
                        n ||
                            (i.body
                                ? (((e = i.createElement("iframe")).style.cssText = "display:none"),
                                  (e.name = t),
                        ...
                        (0, s.win.__gpp)(
                            ...
                            function (t, e) {
                                ...
                                i &&
                                    ...
                                    i.source.postMessage(a ? JSON.stringify(t) : t, i.origin || "*");
                            },
                            n.parameter
                        ));
                }),
        ...
        m =
            ...
            (h.prototype.fetchBannerSDKDependency = function () {
                (this.setDomainDataFileURL(),
                    (this.crossOrigin = p.stubScriptElement.getAttribute("crossorigin") || null),
                    (this.previewMode = "true" === p.stubScriptElement.getAttribute("data-preview-mode")),
            ...
            (h.prototype.getLocation = function (t) {
                if (
                    ...
                    ((t.TenantFeatures && t.TenantFeatures.CookieV2CSP) || t.CookieV2CSPEnabled) &&
                        this.nonce &&
                        ((this.setAttributePolyfillIsActive = !0), new n().implementThePolyfill()),
                    !t.RuleSet[0].Type)
                )
                    return (
                        (this.iabTypeAdded = !1),
                ...
                i.OneTrust && i.OneTrust.geolocationResponse
                    ? ((i = i.OneTrust.geolocationResponse),
                      ...
                      this.addBannerSDKScript(t))
                    : (i = this.readCookieParam(p.optanonCookieName, p.geolocationCookiesParam)) || t.SkipGeolocation
                      ? ((e = i.split(";")[0]),
                        (i = i.split(";")[1]),
            ...
            (h.prototype.handleBulkDomainMgmt = function (t, e) {
                (window.sessionStorage &&
                    window.sessionStorage.setItem("bulkDomainMgmtEnabled", JSON.stringify(t.isValid)),
            ...
            (h.prototype.validateIABGlobalScope = function () {
                ...
                t
                    ? "true" === t
                        ...
                        : ((p.hasIABGlobalScope = !1), (p.IABCookieValue = this.getCookie(p.oneTrustIABCookieName)))
                    : (p.isStubReady = !1);
            }),
            ...
            (h.prototype.updateGtmMacros = function () {
                ...
                for (e = p.optanonHostData.length, i = 0; i < e; i++)
                    this.endsWith(p.optanonHostData[i], ":1") && t.push(p.optanonHostData[i].replace(":1", ""));
                for (e = p.genVendorsData.length, i = 0; i < e; i++)
                    this.endsWith(p.genVendorsData[i], ":1") && t.push(p.genVendorsData[i].replace(":1", ""));
                for (e = p.vendorsServiceData.length, i = 0; i < e; i++)
                    this.endsWith(p.vendorsServiceData[i], ":1") && t.push(p.vendorsServiceData[i].replace(":1", ""));
                var n,
            ...
            (h.prototype.setStubScriptElement = function () {
                ...
                var t = p.stubScriptElement && 0 <= p.stubScriptElement.getAttribute("src").indexOf("did=");
                p.stubScriptElement && p.stubScriptElement.hasAttribute(p.DATAFILEATTRIBUTE)
                    ? (this.domainId = p.stubScriptElement.getAttribute(p.DATAFILEATTRIBUTE).trim())
                    : t
                      ? (this.domainId = p.stubScriptElement.getAttribute("src").split("did=")[1])
                      : p.stubScriptElement ||
                        ((p.stubScriptElement = document.querySelector("script[src*='" + p.migratedCCTID + "']")),
                        p.stubScriptElement && ((p.isMigratedURL = !0), (this.domainId = p.migratedDomainId.trim())));
            }),
            (h.prototype.setDomainDataFileURL = function () {
                ...
                (t &&
                    (p.isMigratedURL
                        ...
                        : (p.storageBaseURL = (
                              e ? t.split("/consent") : t.split("/scripttemplates/" + p.stubFileName)
                          )[0])),
                    (this.storageBaseURL = p.storageBaseURL),
                    this.isPreview && -1 === this.domainId.indexOf("test")
                        ? (this.domainId = this.domainId + "-test")
                        : (this.isPreview = !1),
                    (p.bannerBaseDataURL = p.storageBaseURL && p.storageBaseURL + "/consent/" + this.domainId),
                    (p.bannerDataParentURL = p.bannerBaseDataURL + "/" + this.domainId + ".json"));
            }),
            ...
            (h.prototype.updateVersion = function (t) {
                ("debug" !== this.buildType && "cybuild" !== this.buildType) || (t.Version = "202312.1.0");
            }),
            h);
    function h() {
        var s = this;
        ((this.iabType = null),
            ...
            (this.addBannerSDKScript = function (t) {
                var e = s.getRegionSet(t),
                    i =
                        ...
                        s.iabTypeAdded &&
                            (("IAB2" !== e.Type && "IAB2V2" !== e.Type) || ((s.iabType = e.Type), s.intializeIabStub()),
                            "IAB2" !== e.Type) &&
                            "IAB2V2" !== e.Type &&
                            s.removeTcf(),
                    ...
                    n = t.UseSDKRefactor
                        ? (p.isMigratedURL &&
                              (i.src =
                                  p.storageBaseURL + "/scripttemplates/new/scripttemplates/" + p.stubFileName + ".js"),
                          p.storageBaseURL +
                        ...
                        : "5.11.0" === t.Version
                          ? (p.isMigratedURL &&
                                (i.src =
                                    ...
                                    p.stubFileName +
                                    ".js"),
                            p.storageBaseURL + "/scripttemplates/old/scripttemplates/5.11.0/" + p.bannerScriptName)
                          : (p.isMigratedURL &&
                                (i.src = p.storageBaseURL + "/scripttemplates/" + p.stubFileName + ".js"),
                            p.storageBaseURL + "/scripttemplates/" + t.Version + "/" + p.bannerScriptName);
                ([
                    "charset",
                    "data-language",
            ...
            (this.intializeIabStub = function () {
                var t = window;
                (s.iabTypeAdded
                    ? (void 0 === t.__tcfapi && (window.__tcfapi = s.executeTcfApi), s.addIabFrame())
