...
const FileUpload: React.FC<UploadProps> = (props) => {
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement>) => { const newValue = e.target.value; setNameValue(newValue); 
  ...
  <label>
    ...
    Documento
      ...
      <FileLabel background={disabled} htmlFor="file-upload">Elegir archivo</FileLabel>
    </UploadContainer>
  );
};
